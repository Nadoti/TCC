...
import { formReducer, initialState } from '../../../hooks/formReducer/formReducerRegisterUser.jsx'
    ...
    <S.Container>
      ...
      <S.RegisterContainer>
        ...
        <S.ContentForm onSubmit={handleSubmit}>
          <S.Back href="/register" className='back'><RiArrowLeftLine /></S.Back>
          <S.Title>
      ...
      <S.ImgContainer>
        <S.Img src='/images/registerUsuario.png' alt='Registrar'/>
      </S.ImgContainer>
